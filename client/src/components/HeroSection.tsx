      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="animate-on-scroll space-y-6 lg:space-y-8 order-2 lg:order-1">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-elegant-white text-center lg:text-left leading-tight">
            ...
            <h2 className="text-base sm:text-lg lg:text-xl text-elegant-gold text-center lg:text-left font-medium">
              Mesmo que você ganhe pouco. Mesmo começando do zero. O que você precisa é de direção, não de mais dinheiro.
            </h2>

            <div className="bg-gradient-card shadow-elegant p-4 sm:p-6 lg:p-8 rounded-2xl border-elegant-light">
